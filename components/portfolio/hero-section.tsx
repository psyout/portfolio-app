		...
		<section
			...
			<div className='relative mx-auto w-full max-w-240'>
				<div className='hero-grid grid gap-6 min-[600px]:gap-8 min-[880px]:grid-cols-[minmax(0,1fr)_300px] min-[880px]:gap-12 min-[1040px]:grid-cols-[minmax(0,1fr)_330px] min-[1040px]:gap-16'>
					<div>
						<h1 className='hero-title m-0 max-w-[760px] text-[clamp(38px,12vw,52px)] font-bold leading-[.9] tracking-[-.058em] min-[761px]:text-[clamp(52px,7.4vw,88px)]'>
						...
						<div className='hero-actions mt-6 flex flex-wrap gap-2.5 min-[761px]:mt-10'>
							...
							<a
								className='button-hover group inline-flex min-h-11 items-center gap-2.5 rounded-full border border-portfolio-pine/25 bg-white/60 px-4 text-[13px] font-semibold no-underline hover:border-portfolio-title hover:bg-portfolio-title hover:text-white min-[420px]:gap-3 min-[420px]:px-5 min-[420px]:text-[14px]'
								href='#contact'>
								Let&apos;s work together
								<ArrowUpRight
									size={17}
					...
					<aside className='hero-aside border-t border-portfolio-pine/20 pt-4 min-[600px]:pt-5 min-[880px]:border-l min-[880px]:border-t-0 min-[880px]:pl-8 min-[880px]:pt-1'>
						<TypingRole />
						<p className='hero-summary mb-0 mt-3 text-pretty text-[1rem] leading-[1.5] text-portfolio-text/72 min-[600px]:mt-4 min-[600px]:text-[17px] min-[600px]:leading-[1.65]'>
