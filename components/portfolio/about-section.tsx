		...
		<section
			...
			<div className='mx-auto max-w-[960px] border-y border-portfolio-line px-1 py-7 min-[761px]:py-9'>
				<div className='flex flex-wrap items-center justify-between gap-4'>
					<h2 className='m-0 text-xl font-semibold'>About me</h2>
					<a
				...
				<div className='mt-9 grid gap-5 min-[700px]:grid-cols-[.65fr_1.35fr] min-[700px]:gap-12'>
					<div>
						<p className='m-0 text-[12px] font-bold uppercase tracking-[.14em] text-portfolio-title'>How I work</p>
						<h3 className='mb-0 mt-3 max-w-[260px] text-[clamp(24px,3vw,32px)] font-semibold leading-[1.15] tracking-[-.03em]'>Design-aware. Systems-minded.</h3>
					</div>
				...
				<div className='mt-9 grid border-t border-portfolio-line pt-5 min-[560px]:grid-cols-3'>
